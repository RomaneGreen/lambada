...
class Listing(models.Model):
    ...
    Neighborhoods = models.TextField(blank=True,verbose_name="Neighborhoods Served")
    blocks = models.TextField(max_length=100,blank=True,verbose_name="Countys Served")
    amount = models.CharField(max_length=100,blank=True,null=True,verbose_name="AMI")
    ami = models.IntegerField(blank=True,null=True,verbose_name="Amount ")
    minimumcontribution = models.IntegerField(null=True,blank=True,verbose_name="Minimum Contribution")
    ...
    eligible = models.TextField(max_length=1000,blank=True)
